...
from trendradar.runtime.paths import CONFIG_DIR, DATA_DIR

from trendradar.runtime.settings import DOMAINS, DOMAIN_LABELS
...
def _load_current_interests() -> tuple[set, set]:
    ...
    import yaml
    yaml_path = CONFIG_DIR / 'ai_interests.yaml'
