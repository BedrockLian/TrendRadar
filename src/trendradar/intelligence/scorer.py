...
from trendradar.sources.fetch_feeds import _load_config  # Sprint 3 perf
from trendradar.runtime.settings import (
...
def _get_item_authority(item: dict) -> int:
    ...
    from trendradar.intelligence.domain_metadata import _authority
...
def score_item(item: dict, domain: str = 'tech') -> dict:
    ...
    from trendradar.intelligence.domain_metadata import _authority, _econ_boost, _econ_extra, _all_source_category
