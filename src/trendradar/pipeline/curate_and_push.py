...
from trendradar.runtime.settings import get_data_dir, get_cache_dir, get_config_dir, MIN_SCORE, MAX_PER_DOMAIN, DOMAINS, TRENDRADAR_HOME, BRIEFING_RATIO, SCORE_HEAT_WORDS, MAX_SAME_SOURCE, DIVERSITY_PENALTY_FACTOR, MAX_SOURCE_PCT
from trendradar.config.keywords import has_keyword_match, ALL_KEYWORDS
DATA_DIR = get_data_dir()
CACHE_DIR = get_cache_dir()

# ── Sub-module imports ──────────────────────────────────────────────
from trendradar.intelligence.classifier import classify_items
from trendradar.intelligence.scorer import (
    score_item, score_headlines, curate_domain,
    load_penalty_file, load_source_health,
    _get_source_penalty, _get_health_penalty,
)
from trendradar.intelligence.truncator import apply_truncation
from trendradar.intelligence.interest_loader import load_interests


from trendradar.intelligence.domain_metadata import (
