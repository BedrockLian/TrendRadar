...
class TestScore:
    ...
    def _score(self, item, domain='tech'):
        from trendradar.intelligence.scorer import score_item as fn
        return fn(item, domain)

    def _min_score(self):
        from trendradar.runtime.settings import MIN_SCORE
        return MIN_SCORE
    ...
    def test_economy_domain_boost(self):
        from trendradar.intelligence.domain_metadata import _econ_boost
...
class TestCurateDomain:
    ...
    def _curate_domain(self, items, domain):
        from trendradar.intelligence.scorer import curate_domain as fn
        return fn(items, domain)

    def _max_per_domain(self):
        from trendradar.runtime.settings import MAX_PER_DOMAIN
    ...
    def test_diversity_penalty_same_source(self):
        ...
        from trendradar.runtime.settings import MAX_SAME_SOURCE
