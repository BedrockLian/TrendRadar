...
def _patch_scorer_deps():
    ...
    return patch.multiple(
        'trendradar.intelligence.domain_metadata',
...
class TestScoreItem:
    ...
    def test_strong_tech_item_passes(self):
        ...
        from trendradar.intelligence.scorer import score_item
...
class TestCurateDomain:
    ...
    def test_curate_domain_respects_max_per_domain(self):
        ...
        from trendradar.intelligence.scorer import curate_domain
...
class TestPenaltyLoading:
    ...
    def test_load_penalty_file_missing_no_crash(self):
        ...
        from trendradar.intelligence.scorer import load_penalty_file
    ...
    def test_load_penalty_file_valid_json(self, tmp_path):
        ...
        from trendradar.intelligence.scorer import load_penalty_file, _get_source_penalty
