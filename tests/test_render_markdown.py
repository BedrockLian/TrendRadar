...
class TestFormatItem:
    ...
    def test_title_cn_priority(self):
        from trendradar.reporting.render_markdown import _format_item
        item = {
            'title': 'English Title',
            'title_cn': '中文标题',
...
class TestGenerateSection:
    ...
    def test_empty_items_shows_placeholder(self):
        from trendradar.reporting.render_markdown import _generate_section
...
class TestDetectEmoji:
    ...
    def test_heat_dict_with_appearances(self):
        from trendradar.reporting.render_markdown import _detect_emoji
...
class TestShorten:
    ...
    def test_short_text_unchanged(self):
        from trendradar.reporting.render_markdown import _shorten
        text = '短文本'
