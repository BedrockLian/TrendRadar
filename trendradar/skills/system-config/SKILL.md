...
```bash
# 同步到 ~/TrendRadar/
cp -r scripts/ config/ migrations/ references/ ~/TrendRadar/trendradar/
cp ~/.hermes/skills/trendradar/news-secretary/ ~/TrendRadar/trendradar/skills/
cp ~/.hermes/skills/trendradar/self-healing/ ~/TrendRadar/trendradar/skills/
cp ~/.hermes/skills/trendradar/performance-optimizer/ ~/TrendRadar/trendradar/skills/
cp ~/.hermes/skills/trendradar/weekly-report/ ~/TrendRadar/trendradar/skills/
cp ~/.hermes/skills/trendradar/monthly-report/ ~/TrendRadar/trendradar/skills/
cp ~/.hermes/skills/trendradar/system-config/ ~/TrendRadar/trendradar/skills/
...
需手动确保三处一致：技能目录名、frontmatter `name:` 字段、cron 的 `skills:` 列表。
